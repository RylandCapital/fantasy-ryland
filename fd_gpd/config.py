...
if os.path.exists(path) == False:
  ...
  os.mkdir(path+'_historical\\gpd_dk\\')
  os.mkdir(path+'_historical\\gpd_dk\\optimized_team_pools')
  os.mkdir(path+'_historical\\gpd_dk\\ml_datasets')
  os.mkdir(path+'_predict\\')
  os.mkdir(path+'_predict\\gpd_dk\\')
  os.mkdir(path+'_predict\\gpd_dk\\optmized_team_pools\\')
  os.mkdir(path+'_predict\\gpd_dk\\ml_predictions\\')
  os.mkdir(path+'_predict\\gpd_dk\\uploaded_gameday_tickets\\')
