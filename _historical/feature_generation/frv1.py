...
#%%  
    for onlyf in ws:
        try:
            ...
            file = pd.read_csv(mypath + onlyf + '.csv.gz',
                               compression='gzip').sort_values('lineup').drop(
                                       ['my'], axis=1)
            ...
            def flexerror(x, row):
                try:
                    return x.sort_values(by='salary',
                                     ascending=False).iloc[row][slot_cols]
                except:
            ...
            rbslot1.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
            
            
            
            rbslot2 = rblineups.apply(lambda x: x.sort_values(by='salary',
                                     ascending=False).iloc[1])[slot_cols]
            rbslot2.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
            
        
            rbslot3 = rblineups.apply(lambda x: flexerror(x,2))
            rbslot3.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
            ...
            wrslot1 = wrlineups.apply(lambda x: x.sort_values(by='salary',
                                     ascending=False).iloc[0])[slot_cols]
            wrslot1.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
            
            
            wrslot2 = wrlineups.apply(lambda x: x.sort_values(by='salary',
                                     ascending=False).iloc[1])[slot_cols]
            wrslot2.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
            
            
            wrslot3 = wrlineups.apply(lambda x: x.sort_values(by='salary',
                                     ascending=False).iloc[2])[slot_cols]
            wrslot3.drop(['team2', 'proj_sacks', 'int%', 'bargain'],
                         inplace=True, axis=1)
            
            
            wrslot4 = wrlineups.apply(lambda x: flexerror(x, 3))
            wrslot4.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
            
            #te slots
            teslot1 = telineups.apply(lambda x: x.sort_values(by='salary',
                                     ascending=False).iloc[0])[slot_cols]
            teslot1.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
            
            teslot2 = telineups.apply(lambda x: flexerror(x, 1))
            teslot2.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
            ...
            qbslot1 = qblineups.apply(lambda x: x.sort_values(by='salary',
                                     ascending=False).iloc[0])[slot_cols]
            qbslot1.drop(['team2', 'proj_sacks', 'int%', 'bargain'], inplace=True,
                         axis=1)
